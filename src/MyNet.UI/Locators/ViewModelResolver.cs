...
namespace MyNet.UI.Locators
{
    ...
    public class ViewModelResolver : ResolverBase, IViewModelResolver
    {
        ...
        [
                string.Format("{0}.ViewModels.{1}ViewModel", NamingConvention.Up, NamingConvention.ViewName),
                string.Format("{0}.ViewModels.{1}ControlViewModel", NamingConvention.Up, NamingConvention.ViewName),
                string.Format("{0}.ViewModels.{1}WindowViewModel", NamingConvention.Up, NamingConvention.ViewName),
                string.Format("{0}.ViewModels.{1}PageViewModel", NamingConvention.Up, NamingConvention.ViewName),
                string.Format("{0}.ViewModels.{1}ActivityViewModel", NamingConvention.Up, NamingConvention.ViewName),
                string.Format("{0}.ViewModels.{1}FragmentViewModel", NamingConvention.Up, NamingConvention.ViewName),

                string.Format("{0}.ViewModels.{1}ViewModel", NamingConvention.Assembly, NamingConvention.ViewName),
                string.Format("{0}.ViewModels.{1}ControlViewModel", NamingConvention.Assembly, NamingConvention.ViewName),
                string.Format("{0}.ViewModels.{1}WindowViewModel", NamingConvention.Assembly, NamingConvention.ViewName),
                string.Format("{0}.ViewModels.{1}PageViewModel", NamingConvention.Assembly, NamingConvention.ViewName),
                string.Format("{0}.ViewModels.{1}ActivityViewModel", NamingConvention.Assembly, NamingConvention.ViewName),
                string.Format("{0}.ViewModels.{1}FragmentViewModel", NamingConvention.Assembly, NamingConvention.ViewName),

                string.Format("{0}.{1}ViewModel", NamingConvention.Current, NamingConvention.ViewName),
                string.Format("{0}.{1}ControlViewModel", NamingConvention.Current, NamingConvention.ViewName),
                string.Format("{0}.{1}WindowViewModel", NamingConvention.Current, NamingConvention.ViewName),
                string.Format("{0}.{1}PageViewModel", NamingConvention.Current, NamingConvention.ViewName),
                string.Format("{0}.{1}ActivityViewModel", NamingConvention.Current, NamingConvention.ViewName),
                string.Format("{0}.{1}FragmentViewModel", NamingConvention.Current, NamingConvention.ViewName),
        ];
    }
}
