...
{
    public abstract class ItemEditionViewModel<T> : EditionViewModel, IItemEditionViewModel<T> where T : IModifiable, INotifyPropertyChanged, ICloneable, ISettable, IDisposable
    {
