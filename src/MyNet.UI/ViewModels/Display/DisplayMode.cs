...
{
    public class DisplayMode : TranslatableString, IDisplayMode
    {
        ...
        public DisplayMode(string key) : base(key) => ResetCommand = CommandsManager.Create(Reset);
    ...
    {
        public DisplayModeGrid() : base(nameof(DisplayModeGrid)) { }
    }

    public class DisplayModeDetailled : DisplayMode
    {
        public DisplayModeDetailled() : base(nameof(DisplayModeDetailled)) { }
    }

    public class DisplayModeChart : DisplayMode
    {
        public DisplayModeChart() : base(nameof(DisplayModeChart)) { }
    }
    ...
    public class DisplayModeList : DisplayMode
    {
        ...
        public DisplayModeList() : this(null) { }

        public DisplayModeList(string[]? defaultColumns) : base(nameof(DisplayModeList))
        {
    ...
    public class DisplayModeCalendar : DisplayMode
    {
        ...
        public DisplayModeCalendar(TimeUnit timeUnit, int changeValue = 1, string key = nameof(DisplayModeCalendar)) : base(key)
        {
            _unit = timeUnit;
    ...
    {
        public DisplayModeHour() : base(TimeUnit.Hour, 1, nameof(DisplayModeHour)) { }
    }
    ...
    {
        public DisplayModeWeek() : base(TimeUnit.Week, 1, nameof(DisplayModeWeek)) { }
    }

    public class DisplayModeMonth : DisplayModeCalendar
    {
        public DisplayModeMonth() : base(TimeUnit.Month, 1, nameof(DisplayModeMonth)) { }
    }

    public class DisplayModeYear : DisplayModeCalendar
    {
        public DisplayModeYear() : base(TimeUnit.Year, 1, nameof(DisplayModeYear)) { }
    }
}
