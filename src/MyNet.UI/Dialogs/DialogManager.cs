...
namespace MyNet.UI.Dialogs
{
    ...
    public static class DialogManager
    {
        ...
        public static async Task<MessageBoxResult> ShowSuccessAsync(string message, string? title = null,
            MessageBoxResultOption buttons = MessageBoxResultOption.Ok) => await ShowMessageAsync(message, title ?? UiResources.Success, buttons, MessageSeverity.Success, MessageBoxResult.OK).ConfigureAwait(false);
